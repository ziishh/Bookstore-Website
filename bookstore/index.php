...
while($row = $result->fetch_assoc()) { 
    ...
    echo "<td>";
    echo "<table>";
    echo '<tr><td>'.'<img src="'.$row["Image"].'" width="140px">'.'</td></tr><tr><td style="padding: 5px;">Title: '.$row["BookTitle"].'</td></tr><tr><td style="padding: 5px;">Author: '.$row["Author"].'</td></tr><tr><td style="padding: 5px;">Type: '.$row["Type"].'</td></tr><tr><td style="padding: 5px;">Price:$'.$row["Price"].'</td></tr><tr><td style="padding: 5px;">
    <form action="" method="post">
    Quantity: <input type="number" value="1" name="quantity" style="width: 40%"/><br>
...
if ($count % 5 != 0) {
    ...
    echo "<table style='width:100%; float:right;'>";
    ...
    while($row = $result->fetch_assoc()){
    	echo "<tr><td>";
    	echo '<img src="'.$row["Image"].'"width="5%"><br>';
    	echo $row['BookTitle']."<br>$".$row['Price']."<br>";
    	echo "Quantity: ".$row['Quantity']."<br>";
    	echo "Total Price: $".$row['TotalPrice']."</td></tr>";
    	$total += $row['TotalPrice'];
    }
    echo "<tr><td style='text-align: right;background-color: rgb(248,228,217);''>";
