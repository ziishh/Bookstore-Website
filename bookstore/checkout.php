<html>
<body style="font-family:Arial; margin: 0 auto; background-color: rgb(248,228,217);">
<header>
<blockquote>
...
<?php
	...
	echo "<tr><td style='background-color: rgb(248,228,217);'></td><td style='text-align: right;background-color: #ccc;''>Total Price: <b>RM".$total."</b></td></tr>";
	echo "</table>";
	echo "</div>";
...
input[type=text]:focus {
    border: 2px solid rgb(248,228,217);
}
textarea {
	outline: none;
	border: 2px solid #ccc;
...
.button{
    background-color:rgb(123,87,75);
    border: none;
    border-radius: 20px;
    text-align: center;
    transition-duration: 0.5s; 
...
.button:hover {
    background-color: rgb(199, 160, 147);
    color: #000;
}
table {
...
if(isset($_POST['submitButton'])){
	...
	$total = 0;
	while($row = $result->fetch_assoc()){
		echo "<tr><td style='border-top: 2px solid rgb(248,228,217);'>";
		echo '<img src="'.$row["Image"].'"width="20%"></td><td style="border-top: 2px solid #ccc;">';
    	echo $row['BookTitle']."<br>RM".$row['Price']."<br>";
    	echo "Quantity: ".$row['Quantity']."<br>";
    	echo "</td></tr>";
	...
	echo "<tr><td style='background-color: rgb(248,228,217);'></td><td style='text-align: right;background-color: rgb(248,228,217);'>Total Price: <b>RM".$total."</b></td></tr>";
	echo "</table>";
